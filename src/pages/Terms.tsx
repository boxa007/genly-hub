    ...
    <div className="min-h-screen bg-navy-900 text-white">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg prose-invert max-w-none space-y-6">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-purple-400 mb-4">3. Data Collection and Use</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-purple-400 mb-4">4. User Responsibilities</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-purple-400 mb-4">5. Limitation of Liability</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-purple-400 mb-4">7. Contact Information</h2>
            <p className="text-text-secondary leading-relaxed">
