    ...
    <div className="min-h-screen bg-navy-900 text-white">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg prose-invert max-w-none space-y-6">
          <section>
            <h2 className="text-2xl font-semibold text-accent-purple mb-4">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-accent-purple mb-4">2. How We Use Your Information</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-accent-purple mb-4">3. Data Security</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-accent-purple mb-4">4. Data Sharing</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-accent-purple mb-4">5. Data Retention</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-accent-purple mb-4">6. Your Rights</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-accent-purple mb-4">7. Changes to This Policy</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-accent-purple mb-4">8. Contact Us</h2>
            <p className="text-text-secondary leading-relaxed">
